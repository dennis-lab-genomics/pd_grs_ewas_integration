...
Last updated May 17, 2025 by Samantha Schaffner: Adjusting GRS liability and heritability calculations for DIG-PD (using the scaled GRS, removing DNAm-related covariates from the model, changing liability scale calculation to represent Lee et al., Am J Hum Genet 2011.)
...
h2_labels <- c(0.0311, 0.0245,0.0413)
...
png("~/PD_GRS/DIGPD_prs_plots_by_PD_sex_17May2025.png", width=600, height=500)
ggboxplot(
  to_plot,
  x = "PD",
  y = "GRS_scaled",
