...
Last updated June 9, 2025 by Samantha Schaffner: Pulling full list of SNP x E interaction stats
...
snp_alc <- lapply(1:8, function(x){
  ...
  res.alc1.3 <- topTable(snp_E_fit, coef=30, num=Inf, adjust.method="BH")
  res.alc1.3 <- res.alc1.3[,c("logFC","P.Value","adj.P.Val")]
  colnames(res.alc1.3) <- c(paste(snp,":alcohol1.3",".coef",sep=""), paste(snp,":alcohol1.3",".pvalue",sep=""), paste(snp,":alcohol1.3",".p.adj",sep=""))
  
  res.alc1.4 <- topTable(snp_E_fit, coef=31, num=Inf, adjust.method="BH")
...
#           CpG                  SNPxE       coef       pvalue       p.adj
#34  cg09793084 rs138017112:alcohol1.2 -7.0941294 6.944686e-04 0.007639155
#56  cg09793084 rs138017112:alcohol1.4 -7.8700396 4.770536e-05 0.000524759
#57  cg09860564 rs138017112:alcohol1.4 -5.3378352 4.510438e-03 0.024807406
#89  cg09793084  rs17686238:alcohol1.4  2.6507305 3.487554e-03 0.038363098
#122 cg09793084  rs62053943:alcohol1.4 -0.2629263 3.364177e-03 0.037005942
...
snp_ht <- lapply(1:8, function(x){
  ...
  res <- topTable(snp_E_fit, coef=27, num=Inf, adjust.method="BH")
...
#          CpG                   SNPxE       coef      pvalue       p.adj
#12 cg27060340 rs138017112:head_trauma  2.6679705 0.001931176 0.018841069
#13 cg09860564 rs138017112:head_trauma -1.9478375 0.003425649 0.018841069
#14 cg15072451 rs138017112:head_trauma  6.1944139 0.007854620 0.028800275
#23 cg27060340  rs17686238:head_trauma  5.1874615 0.001167224 0.008160269
#24 cg09860564  rs17686238:head_trauma -0.8258762 0.001483685 0.008160269
#25 cg15072451  rs17686238:head_trauma  4.1223356 0.005568294 0.017323858
#26 cg20163478  rs17686238:head_trauma  0.7590142 0.006409537 0.017323858
#27 cg09793084  rs17686238:head_trauma  1.4279101 0.008763678 0.017323858
#28 cg04226788  rs17686238:head_trauma  1.2051460 0.010273286 0.017323858
#29 cg12609785  rs17686238:head_trauma -1.0223039 0.011024273 0.017323858
#30 cg05314706  rs17686238:head_trauma  0.6346442 0.025149427 0.033584884
#31 cg02478991  rs17686238:head_trauma  1.3848838 0.027478541 0.033584884
...
snp_pest <- lapply(1:8, function(x){
  ...
  res.pest1 <- topTable(snp_E_fit, coef=28, num=Inf, adjust.method="BH")
  ...
  res.pest2 <- topTable(snp_E_fit, coef=29, num=Inf, adjust.method="BH")
...
write.csv(SNPxE_non_imp, file="~/PD_GRS/non_genetic_sensitivity/SNPxE_non_imp_detailed.csv", row.names=F)
```
...
#             CpG            SNPxE       coef       pvalue       p.adj
#2711  cg27060340 rs138017112:fong  1.9595215 0.0134620671 0.021154677
#2712  cg05314706 rs138017112:fong -1.6239224 0.0058112850 0.012784827
#2741  cg01341218 rs138017112:fong -0.7981302 0.0129152863 0.021154677
#2751  cg09793084 rs138017112:fong  7.7823804 0.0001497420 0.001647162
#2761  cg15072451 rs138017112:fong  0.9397048 0.0052043112 0.012784827
#2771  cg04226788 rs138017112:fong  1.3494719 0.0207112158 0.025313708
#2781  cg02478991 rs138017112:fong  0.9398186 0.0047419047 0.012784827
#2791  cg09860564 rs138017112:fong  2.0616158 0.0165391852 0.022741380
#27101 cg15633388 rs138017112:fong  6.8970885 0.0003614449 0.001987947
...
#             CpG            SNPxE       coef       pvalue       p.adj
#2711  cg27060340 rs138017112:herb  1.9320632 0.0198061349 0.032653953
#2712  cg05314706 rs138017112:herb -1.5712339 0.0106607816 0.023453720
#2741  cg01341218 rs138017112:herb -0.7598715 0.0207797883 0.032653953
#2751  cg09793084 rs138017112:herb  7.5431447 0.0006705392 0.004704698
#2761  cg15072451 rs138017112:herb  0.9772548 0.0047266921 0.017331204
#2771  cg04226788 rs138017112:herb  1.3151739 0.0319977282 0.040476594
#2781  cg02478991 rs138017112:herb  0.9148577 0.0086666647 0.023453720
#2791  cg09860564 rs138017112:herb  1.8854527 0.0331172130 0.040476594
#27101 cg15633388 rs138017112:herb  6.8448672 0.0008553996 0.004704698
...
write.csv(SNPxE_imp, file="~/PD_GRS/non_genetic_sensitivity/SNPxE_imp_detailed.csv", row.names=F)
```
...
snp_smoking <- lapply(1:8, function(x){
  ...
  res.smoke2 <- topTable(snp_E_fit, coef=26, num=Inf, adjust.method="BH")
  res.smoke2 <- res.smoke2[,c("logFC","P.Value","adj.P.Val")]
  colnames(res.smoke2) <- c(paste(snp,":smoking2",".coef",sep=""), paste(snp,":smoking2",".pvalue",sep=""), paste(snp,":smoking2",".p.adj",sep=""))
...
snp_smoking_melt[which(snp_smoking_melt$p.adj<=0.05),]
#          CpG              SNPxE       coef      pvalue      p.adj
#56 cg12609785 rs7221167:smoking2 -0.8728228 0.006892858 0.04323164
#57 cg15072451 rs7221167:smoking2 -1.0165431 0.007860299 0.04323164
...
snp_alc <- lapply(1:8, function(x){
  ...
  res.alc1.2 <- topTable(snp_E_fit, coef=28, num=Inf, adjust.method="BH")
  res.alc1.2 <- res.alc1.2[,c("logFC","P.Value","adj.P.Val")]
  colnames(res.alc1.2) <- c(paste(snp,":alcohol1.2",".coef",sep=""), paste(snp,":alcohol1.2",".pvalue",sep=""), paste(snp,":alcohol1.2",".p.adj",sep=""))
  
  res.alc1.3 <- topTable(snp_E_fit, coef=29, num=Inf, adjust.method="BH")
  res.alc1.3 <- res.alc1.3[,c("logFC","P.Value","adj.P.Val")]
  colnames(res.alc1.3) <- c(paste(snp,":alcohol1.3",".coef",sep=""), paste(snp,":alcohol1.3",".pvalue",sep=""), paste(snp,":alcohol1.3",".p.adj",sep=""))
...
snp_alc_melt[which(snp_alc_melt$p.adj<=0.05),]
#           CpG                  SNPxE       coef      pvalue       p.adj
#34  cg09793084 rs138017112:alcohol1.2 -9.1509169 0.000213051 0.002343561
#35  cg20163478 rs138017112:alcohol1.2 -7.6718945 0.001103831 0.006071070
#56  cg09793084 rs138017112:alcohol1.4 -7.0901404 0.001513471 0.016648186
#144 cg09793084   rs9912362:alcohol1.3 -0.4347953 0.003854021 0.042394234
#177 cg09793084   rs7221167:alcohol1.3 -2.2516848 0.003478930 0.038268226
...
snp_ht_melt <- left_join(snp_ht_melt, snp_ht_padj_melt, by=c("CpG","SNPxE"))
snp_ht_melt[which(snp_ht_melt$p.adj<=0.05),]
min(snp_ht_melt$p.adj[complete.cases(snp_ht_melt$p.adj)])
#0.3057652
...
snp_pest_melt[which(snp_pest_melt$p.adj<=0.05),] #none
#          CpG                   SNPxE       coef      pvalue      p.adj
#34 cg27060340 rs138017112:pesticides2  7.5073256 0.005939077 0.02641039
#35 cg05314706 rs138017112:pesticides2 -2.0596048 0.007707986 0.02641039
#36 cg20163478 rs138017112:pesticides2 -2.9510374 0.007942720 0.02641039
#37 cg12609785 rs138017112:pesticides2  3.6984778 0.009603779 0.02641039
#38 cg01341218 rs138017112:pesticides2 -6.4641638 0.014359263 0.03159038
#39 cg09793084 rs138017112:pesticides2 -1.0414255 0.022303874 0.04089044
#40 cg15072451 rs138017112:pesticides2 -0.9873529 0.026368215 0.04143577
#41 cg04226788 rs138017112:pesticides2 -6.0703736 0.031635701 0.04349909

### save all results
SNPxE_non_imp_ctrl <- rbind(snp_smoking_melt, snp_alc_melt, snp_ht_melt, snp_pest_melt)
write.csv(SNPxE_non_imp_ctrl, file="~/PD_GRS/non_genetic_sensitivity/SNPxE_non_imp_ctrl_detailed.csv", row.names=F)
```
...
snp_fong[which(snp_fong$p.adj<=0.05),]
#            CpG         SNPxE      coef      pvalue      p.adj
#2627 cg27060340 rs199453:fong 0.4021764 0.002723758 0.02996133
...
write.csv(SNPxE_imp_ctrl, file="~/PD_GRS/non_genetic_sensitivity/SNPxE_imp_ctrl_detailed.csv", row.names=F)
```
