...
ggplot(to_plot, aes(pos,value, color= SCORE1_AVG))+ geom_point(alpha = 0.5) + scale_color_distiller(palette = "Spectral") + theme_minimal()
ggplot(to_plot, aes(pos,value, color= as.factor(PD)))+ geom_point() + scale_color_brewer(palette = "Dark2") + theme_minimal()+ stat_summary(aes(group=as.factor(PD)), fun.y=mean, geom="line")
