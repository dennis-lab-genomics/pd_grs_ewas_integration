...
ggboxplot(
  ...
  labs(y = "Polygenic Risk Score", x = "Parkinson's Diagnosis") +
  ggtitle(bquote(R^2 ~ ": 0.0611; " ~ h^2 ~ ": " ~ .(round(h2, 4))))
...
plot_dmrs <- function(dmr_res, limma_res, palette, case_control) {
...
plot_dmrs(prs_dmr, prs_res, "RdBu", rev(c("gray80", "gray40")))
plot_dmrs(male_prs_dmr, male_res, "RdBu", rev(c("light blue", "lightblue4")))
plot_dmrs(female_prs_dmr, female_res, "RdBu", rev(c("lightpink", "lightpink4")))
```
