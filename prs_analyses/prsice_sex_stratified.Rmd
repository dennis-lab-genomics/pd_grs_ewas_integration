...
to_plot <- rbind(male_plot,female_plot) %>% mutate(threshold = recode_factor(threshold,`Pt_5e-08` = "5e-8", `Pt_5.005e-05` = "5e-5", `Pt_0.00010005` = "1e-4", `Pt_0.0101501` = "1e-2", `Pt_0.1` = "0.1", `Pt_0.2` = "0.2", `Pt_0.3` = "0.3", `Pt_0.4` = "0.4", `Pt_0.5` = "0.5", `Pt_1` = "1.0",`Pt_0.00675005` = "Male-stratified best",`Pt_0.00100005` = "Female-stratified best"))
...
gmirror(
  ...
  annotate_p = c(max(top_male_ewas[adj.P.Val<0.26]$P.Value),max(top_female_ewas[adj.P.Val<0.25]$P.Value)),
  tline =  max(top_male_ewas[adj.P.Val<0.25]$P.Value),
  bline =  max(top_female_ewas[adj.P.Val<0.25]$P.Value),
  highlight_p = c(max(top_male_ewas[adj.P.Val<0.26]$P.Value),max(top_female_ewas[adj.P.Val<0.25]$P.Value)),
  toptitle="Male-stratified",
  bottomtitle ="Female-stratified",
  highlighter="green",
  background="white"
)
```
