...
```{r, out.width="400px"}
include_graphics("prsice_images/TERRE_male_PRSice_BARPLOT_2022-07-07.png")
include_graphics("prsice_images/TERRE_male_PRSice_HIGH-RES_PLOT_2022-07-07.png")
include_graphics("prsice_images/TERRE_male_PRSice_QUANTILES_PLOT_2022-07-07.png")
include_graphics("prsice_images/TERRE_female_PRSice_BARPLOT_2022-07-07.png")
include_graphics("prsice_images/TERRE_female_PRSice_HIGH-RES_PLOT_2022-07-07.png")
include_graphics("prsice_images/TERRE_female_PRSice_QUANTILES_PLOT_2022-07-07.png")
```
...
```{r}
# Get SNPs
male <- fread("/home1/NEURO/casazza/Blauwendraat_male_female_GWAS/MALE_PD_filtered_sumstats_no_multi_allelics_RSID.QC.txt.gz")[p < 0.00675005 & MAF > 0.01]
female <- fread("/home1/NEURO/casazza/Blauwendraat_male_female_GWAS/FEMALE_PD_filtered_sumstats_no_multi_allelics_RSID.QC.txt.gz")[p < 0.00240005 & MAF > 0.01]
all_sex <- fread("/home1/NEURO/casazza/nalls_PD.QC.gz")[p < 0.00030005 & MAF > 0.01]
```
...
prsice_female_all <- fread("prsice_female_data/TERRE_female_PRSice.all_score")[match(colnames(betas_female), IID), .(FID, IID, `Pt_0.00240005`, `Pt_5e-08`, `Pt_5.005e-05`, `Pt_0.00010005`, `Pt_0.00100005`, `Pt_0.0101501`, `Pt_0.1`, `Pt_0.2`, `Pt_0.3`, `Pt_0.4`, `Pt_0.5`, `Pt_1`)]
...
ggplot(hits_by_thresh_bonf_male[, .(hits = .N), by = threshold] %>% mutate(threshold = recode_factor(threshold, `Pt_0.00675005` = "6.75e-3", `Pt_5e-08` = "5e-8", `Pt_5.005e-05` = "5e-5", `Pt_0.00010005` = "1e-4", `Pt_0.00100005` = "1e-3", `Pt_0.0101501` = "1e-2", `Pt_0.1` = "0.1", `Pt_0.2` = "0.2", `Pt_0.3` = "0.3", `Pt_0.4` = "0.4", `Pt_0.5` = "0.5", `Pt_1` = "1.0")), aes(threshold, hits, label = hits)) +
...
ggplot(hits_by_thresh_bonf_female[, .(hits = .N), by = threshold] %>% mutate(threshold = recode_factor(threshold, `Pt_0.00240005` = "2.40e-3", `Pt_5e-08` = "5e-8", `Pt_5.005e-05` = "5e-5", `Pt_0.00010005` = "1e-4", `Pt_0.00100005` = "1e-3", `Pt_0.0101501` = "1e-2", `Pt_0.1` = "0.1", `Pt_0.2` = "0.2", `Pt_0.3` = "0.3", `Pt_0.4` = "0.4", `Pt_0.5` = "0.5", `Pt_1` = "1.0")), aes(threshold, hits, label = hits)) +
  geom_text(vjust = -0.25) +
  geom_col() +
  labs(x = "GWAS P Value Threshold", y = "EWAS Hits") +
  theme_minimal()
