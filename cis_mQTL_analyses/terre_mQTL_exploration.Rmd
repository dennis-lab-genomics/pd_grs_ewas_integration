...
mQTL_results_digpd <- fread("digpd_data/cis_all_impute_mQTL_results_9_methy_PC.txt")
...
to_check_replication <- fread("to_check_replication_terre_digpd_bonf.txt")
by_cpg <- to_check_replication[,.(p1= min(`p-value.x`),p2=min(`p-value.y`)),by="gene"]
tmp <- pi0est(to_check_replication$`p-value.y`)
tmp <- pi0est(to_check_replication$p2)
```
## Colocalization with parkinson's loci
```{r}
probe_pos <- fread("~/cis_mQTL_analyses/terre_data/probe_pos.txt")
snp_pos <- fread("~/cis_mQTL_analyses/terre_data/snp_pos.txt",key="SNP")
...
## Plot out results
```{r}
res1 %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3)
res1_pval %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3)%>% filter(PP3_4 > 0.99, PP_4div3 > 5) 
res1_pval %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3)%>% filter(PP3_4 > 0.99, PP_4div3 > 5)  %>% distinct(probe,locus)
res1_pval %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3)%>% filter(PP3_4 > 0.99, PP_4div3 > 5)  %>% distinct(probe)
res1_pval %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3)%>% filter(PP3_4 > 0.99, PP_4div3 > 5)  %>% distinct(locus)
```
```{r}
res1_pval %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3)%>% filter(PP3_4 > 0.99, PP_4div3 > 5)  %>% write_delim("mqtl_pd_snp_colocalized_blood.txt")
```
...
```{r}
probe_res %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3)
...
```
```{r}
coloc_brain %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3) %>% filter(PP3_4 > 0.99, PP_4div3 > 5)
coloc_brain %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3) %>% filter(PP3_4 > 0.99, PP_4div3 > 5) %>% distinct(probe,locus)
coloc_brain %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3) %>% filter(PP3_4 > 0.99, PP_4div3 > 5) %>% distinct(probe)
coloc_brain %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3) %>% filter(PP3_4 > 0.99, PP_4div3 > 5) %>% distinct(locus)
```
```{r}
coloc_brain %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3) %>% filter(PP3_4 > 0.99, PP_4div3 > 5) %>% write_delim("mqtl_pd_snp_colocalized_brain.txt")
```
## Visualizing colocalization
```{r,fig.height=8.5, fig.height=11}
library(EnsDb.Hsapiens.v86)
edb <- EnsDb.Hsapiens.v86
blood_cpg <- res1_pval %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3)%>% dplyr::filter(PP3_4 > 0.99, PP_4div3 > 5)
brain_cpg <- coloc_brain %>% mutate(PP3_4 = PP.H3.abf + PP.H4.abf, PP_4div3 = PP.H4.abf/PP.H3.abf) %>% arrange(-PP3_4,-PP_4div3)%>% dplyr::filter(PP3_4 > 0.99, PP_4div3 > 5)
...
plot_cpgs_overlap <- function(cpgs, blood_highlight, brain_highlight){
  ...
  gr <- GeneRegionTrack(
          getGeneRegionTrackForGviz(
              edb, chromosome = gsub("chr","",unique(cpg_coord$chr)),
  ...
  plotTracks(
        HighlightTrack(
            list(reg,cgi,dat,gr), start=c(blood_coord$s1,brain_coord$s1),width=75e3,
