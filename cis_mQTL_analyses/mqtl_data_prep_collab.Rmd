...
male_meta_to_write <-as.data.table(model.matrix(~0+.,data=male_meta[,.(PD,age,smoking,alcohol1=factor(alcohol1),head_trauma, CTP_PC1,CTP_PC2,CTP_PC3,CTP_PC4,ancestryPC1,ancestryPC2,ancestryPC3,plate=factor(plate),SentrixPosition_A=factor(SentrixPosition_A))]))
...
female_meta_to_write <- as.data.table(model.matrix(~0+.,data=female_meta[,.(PD,age,smoking,alcohol1=factor(alcohol1),head_trauma, CTP_PC1,CTP_PC2,CTP_PC3,CTP_PC4,ancestryPC1,ancestryPC2,ancestryPC3,plate=factor(plate),SentrixPosition_A=factor(SentrixPosition_A))]))
