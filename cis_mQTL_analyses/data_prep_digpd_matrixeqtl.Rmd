...
write_delim(t(covar) %>% as.data.frame() %>% rownames_to_column("id"), "digpd_data/covariates_CTP_no_mut.txt")
```
## Write CTP data
UPDATE: changed names for files without mutants
```{r}
...
write_delim(t(cbind(digpd_meta[digpd_meta$men == 1, c("U1", "U2", "U3", "PD", "Age", "CTP_PC1", "CTP_PC2", "CTP_PC3", "CTP_PC4", "CTP_PC5")])) %>% as.data.frame() %>% rownames_to_column("id"), "digpd_data/male_covariates_PD_CTP_no_mut.txt")
write_delim(t(cbind(digpd_meta[digpd_meta$men == 0, c("U1", "U2", "U3", "PD", "Age", "CTP_PC1", "CTP_PC2", "CTP_PC3", "CTP_PC4", "CTP_PC5")])) %>% as.data.frame() %>% rownames_to_column("id"), "digpd_data/female_covariates_PD_CTP_no_mut.txt")
