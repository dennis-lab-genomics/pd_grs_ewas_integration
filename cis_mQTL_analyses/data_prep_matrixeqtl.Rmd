...
write_delim(t(cbind(terre_meta[terre_meta$men == 1,c("V3","V4","V5","age","head_trauma","CTP_PC1", "CTP_PC2", "CTP_PC3", "CTP_PC4", "CTP_PC5")])) %>% as.data.frame() %>% rownames_to_column("id"),"terre_data/male_covariates_CTP.txt")
write_delim(t(cbind(terre_meta[terre_meta$men == 0,c("V3","V4","V5","age","head_trauma","CTP_PC1", "CTP_PC2", "CTP_PC3", "CTP_PC4", "CTP_PC5")])) %>% as.data.frame() %>% rownames_to_column("id"),"terre_data/female_covariates_CTP.txt")
```
