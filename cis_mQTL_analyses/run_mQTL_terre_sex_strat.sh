...
/usr/local/R-3.6.2/bin/Rscript run_matrixEQTL.R --data_dir="terre_data/" \
  ...
  --cov_file="female_covariates_CTP.txt"\
  --cis_outfile="female_cis_all_impute_mQTL_results_CTP.txt"\
  --snp_pos="snp_pos.txt"\
...
/usr/local/R-3.6.2/bin/Rscript run_matrixEQTL.R --data_dir="terre_data/" \
  ...
  --cov_file="male_covariates_CTP.txt"\
  --cis_outfile="male_cis_all_impute_mQTL_results_CTP.txt"\
  --snp_pos="snp_pos.txt"\
